      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="mt-16 space-y-[72px]">
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="border border-[#d9d9d9] rounded-3xl p-4 transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl">
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <div className="order-1 border border-[#d9d9d9] rounded-3xl p-4 md:order-2 transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl">
